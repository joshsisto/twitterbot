## copied and formatted from  http://10xreading.com/33-strategies-of-war-pdf/
strats_list = [
	...
	[ 'Self-Directed Warfare',
	  'Strategy 3',
      'AMIDST THE TURMOIL OF EVENTS, DONOT LOSE YOUR PRESENCE OF MIND: THE COUNTERBALANCE STRATEGY',
	...
	[ '(DIRTY) WARFARE',
	  'Strategy 23',
      'WEAVE A SEAMLESS BLEND OF FACT AND FICTION: MISCONCEPTION STRATEGIES',
    ...
    [ '(DIRTY) WARFARE',
	  'Strategy 28',
      'GIVE YOUR RIVALS ENOUGH ROPE TOHANG THEMSELVES: THE ONE-UP MAN SHIP STRATEGY',
	...
	[ '(DIRTY) WARFARE',
	  'Strategy 29',
      'TAKE SMALL BITES: THE FAIT ACCOMPLIE STRATEGY',
